...
**py4j-highcharts** is a Java application which starts a
...
jar](https://github.com/downloads/theatlantic/py4j-highcharts/py4j-highcharts.jar).
...
To run the **py4j-highcharts** gateway server, simply call:

    $ java -jar py4j-highcharts.jar
...
Once installed, the HighCharts export methods can be invoked as follows:
...
**py4j-highcharts** also exposes an API for rasterizing SVG images to PNG:
